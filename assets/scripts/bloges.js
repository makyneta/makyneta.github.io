document.addEventListener('DOMContentLoaded', async () => {
    ...
    const categories = [
        { id: 'all', label: 'Todas las categorías', themeClass: 'theme-all' },
        { id: 'dev', label: 'Desarrollo', themeClass: 'theme-dev' },
        { id: 'work', label: 'Trabajo / Portafolio', themeClass: 'theme-work' },
        { id: 'professional', label: 'Carrera', themeClass: 'theme-professional' },
        { id: 'personal', label: 'Personal', themeClass: 'theme-personal' },
        { id: 'design', label: 'Diseño', themeClass: 'theme-design' } 
    ];
    ...
    async function loadArticles() {
        try {
            const response = await fetch('../assets/data/bloges.json');
            ...
            cardsGrid.innerHTML = `<p class="text-red-500">Error al cargar artículos.</p>`;
        }
    }
            ...
            const articleHTML = `
                <article class="blog-card group" data-category="${article.category}">
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <div class="mt-auto">
                            <a href="${article.link}" class="inline-flex items-center text-xs font-bold text-white uppercase tracking-widest hover:text-[current] transition-colors">Read Article &rarr;</a>
                        </div>
                    </div>
                </article>
            `;
